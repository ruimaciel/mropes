...
struct mrope_branch_node *mrope_make_branch_node(struct mrope_node *lhs,
  ...
  if ((node = (struct mrope_branch_node *)malloc(
           sizeof(struct mrope_branch_node))) == NULL) {
    return NULL;
  }
...
struct mrope_leaf_node *mrope_make_leaf_node(void) {
  ...
  if ((node = (struct mrope_leaf_node *)malloc(
           sizeof(struct mrope_leaf_node))) == NULL) {
    return NULL;
  }
...
enum mrope_error_code mrope_free_branch_node(
  ...
  switch (original->type) {
    case MROPE_NODE_BRANCH: {
      ...
      *clone = (struct mrope_node *)node;
      return mrope_clone_branch_node((struct mrope_branch_node *)original,
                                     (struct mrope_branch_node *)*clone);
    }
    ...
    case MROPE_NODE_LEAF: {
      ...
      *clone = (struct mrope_node *)node;
      return mrope_clone_leaf_node((struct mrope_leaf_node *)original,
                                   (struct mrope_leaf_node *)*clone);
    }
...
char mrope_index_branch_node(struct mrope_branch_node *branch_node,
  ...
  if (index < lhs_weight + branch_node->right->weight) {
    return mrope_index_node((struct mrope_node *)branch_node->right,
                            index - lhs_weight);
  }
...
size_t mrope_calculate_weights(struct mrope_node *node) {
  ...
  if (node->type == MROPE_NODE_BRANCH) {
    ...
    return mrope_calculate_weights(branch_node->left) +
           mrope_calculate_weights(branch_node->right);
  }
